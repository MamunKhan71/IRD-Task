const Sidebar = () => {
    return (
        <div className="font-inter lg:hidden 2xl:flex rounded-[32px] flex-col items-end gap-7">
            <div className="bg-white px-5 pt-8 w-full space-y-4 rounded-[32px] border-[0.5px] border-[#E2E2E2]">
