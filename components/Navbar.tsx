...
const Navbar = () => {
  return (
    <div className="font-inter hidden lg:block h-full">
      <div className='flex px-3 py-7 gap-7 h-full flex-col items-center justify-between bg-white w-[100px] rounded-xl'>
        <div>
